...
- [x] Improve setup page: Add LinkedIn profile input field and description editor with face previews during person setup. Use session storage to preserve form data if user navigates away.
