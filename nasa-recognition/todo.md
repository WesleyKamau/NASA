...
- [ ] Improve setup page for descriptions with face previews
...
- [ ] Improve setup page to allow for adding both descriptions and LinkedIn links. Add session storage so if you accidentally refresh you don't lose progress.
